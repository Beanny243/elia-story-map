...
export const SignupEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Welcome to {SITE_NAME} — verify your email to start exploring! 🌍</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={header}>
          <Text style={logo}>🌍 {SITE_NAME}</Text>
        </Section>
        <Heading style={h1}>Welcome, explorer!</Heading>
        <Text style={text}>
          Thanks for joining {SITE_NAME} — where every journey becomes a story.
        </Text>
        <Text style={text}>
          Tap the button below to verify your email and start mapping your adventures:
        </Text>
        ...
        <Text style={smallText}>
          This link will expire shortly. If you didn't create an account, you can safely ignore this email.
        </Text>
